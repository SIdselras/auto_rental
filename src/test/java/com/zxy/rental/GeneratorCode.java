 ...
 */
/**
 * 代码生成器类，用于根据数据库表结构自动生成对应的Java代码文件
 * 包括实体类、Mapper接口、Service层、Controller层以及对应的XML映射文件
 */
@SpringBootTest
public class GeneratorCode {
    private static final String AUTHOR="student_zxy";
    private static final String JDBC_URL="jdbc:mysql://127.0.0.1:3306/auto_rental";
    private static final String JDBC_USERNAME="root";
    private static final String JDBC_PASSWORD="zxy981217";
    private static final String OUT_DIR=".\\src\\main\\java";
    private static final String PACKAGE_NAME="com.zxy";
